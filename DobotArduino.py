"""
First Author: Max
Additional Authors (Additional Authors (Add your name below):
1. Mike Ferguson www.mikeahferguson.com 3/26/2016
License: MIT
#Adapted from Max's open-dobot github repository: https://github.com/maxosprojects/open-dobot
"""
...
#variables starting with an underscore in this class or meant to be private variables
class Dobot:
	#Parameters:
	#comport: The communication (COM) port that the arduino controlling the Dobot arm is connected to.
	def __init__(self, comport, baud):
        #Don't really know what this does, please explain
		self._lock = threading.Lock()
        #initialize the com port value
	...
	def Open(self, timeout=0.1):
		self._port = serial.Serial(self._comport, baudrate=self._baud, timeout=timeout, interCharTimeout=0.01)
